...
**Keycloak running in dev mode**
![Keycloak running](Screenshots/01-keycloak-running.png)

**Admin console login page**
![Admin console login](Screenshots/02-admin-console-login.png)
...
**Create realm form**
![Create realm](Screenshots/04-create-realm.png)

**Realm created — now inside the deontech realm**
![Realm created](Screenshots/05-realm-created.png)
...
3. Inside `IT-Department`, create a **subgroup** called `IT-Admins` to show nested group structure.

### 📸 Screenshots

**All four department groups**
![Groups list](Screenshots/06-groups-list.png)

**Nested IT-Admins subgroup inside IT-Department**
![Nested group](Screenshots/07-nested-group.png)
...
3. After creating each user, go to the **Credentials** tab → **Set password**. Set a temporary password and leave **Temporary** ON so they must reset on first login.
...
**Add user form**
![Create user](Screenshots/08-create-user.png)

**Setting a temporary password**
![Set password](Screenshots/09-set-password.png)

**All six users**
![Users list](Screenshots/10-users-list.png)

**A user's group membership**
![User groups](Screenshots/11-user-groups.png)
...
**All five realm roles**
![Realm roles](Screenshots/12-realm-roles.png)

**Group-to-role mapping**
![Group role mapping](Screenshots/13-group-role-mapping.png)

**Roles inherited via group membership (proves RBAC works)**
![Inherited roles](Screenshots/14-inherited-roles.png)
...
**Password policy**
![Password policy](Screenshots/15-password-policy.png)

**Brute force detection enabled**
![Brute force](Screenshots/16-brute-force.png)
...
**Configure OTP set as default action**
![Required actions](Screenshots/17-required-actions.png)

**OTP enrollment QR screen (QR redacted)**
![OTP enrollment](Screenshots/18-otp-enrollment.png)

**Account console showing two-factor authentication configured**
![Account console](Screenshots/19-account-console.png)

---

## Phase 8 — Integrate an Application (OIDC & SAML Clients)
...
5. Save, then open the **Credentials** tab to view the client secret.
6. Create a second client with type **SAML** named `deontech-saml-app` to demonstrate both protocols.

### 📸 Screenshots

**OIDC client settings**
![OIDC client](Screenshots/20-oidc-client.png)

**Client credentials (secret redacted)**
![Client credentials](Screenshots/21-client-credentials.png)

**SAML client configuration**
![SAML client](Screenshots/22-saml-client.png)
...
1. Go to **Realm settings** → **Events** (or the **Events** item in the sidebar) → **Event configs**.
...
5. View **Events** — you'll see `LOGIN`, `LOGIN_ERROR`, `UPDATE_PASSWORD`, etc.

### 📸 Screenshots

**User & admin event saving enabled**
![Events config](Screenshots/23-events-config.png)

**Event log showing LOGIN and LOGIN_ERROR entries**
![Login events](Screenshots/24-login-events.png)

---

## Phase 10 — Lifecycle Management Demo (Joiner / Mover / Leaver)

Demonstrates the JML lifecycle — a core IAM concept.

### Steps

1. **Joiner:** New user, temp password, group assignment, forced MFA enrollment (done in earlier phases).
2. **Mover:** Move `mbrown` from `IT-Department` to `Finance-Department`. His effective roles change automatically.
...
**Mover — roles before and after group change**
![Mover before after](Screenshots/25-mover-before-after.png)

**Leaver — disabled user and login failure**
![Disabled user](Screenshots/26-disabled-user.png)

**Leaver — event log entry for the denied login**
![Leaver event log](Screenshots/27-leaver-event-log.png)
...
*Built as part of my IAM portfolio targeting IAM Analyst and cybersecurity roles.*
